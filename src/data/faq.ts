...
export const FAQ_ITEMS: FAQItem[] = [
  {
    id: 'q1',
    category: 'program',
    question: 'How is this different from an app or self-paced course?',
    answer:
      'Apps and self-paced courses put the burden of consistency on you. Our program is built the opposite way: fixed start dates, a fixed schedule, a small cohort, and a real instructor. The structure does the hard work so you can focus on learning.',
  },
  {
    id: 'q2',
    category: 'program',
  ...
  },
  {
    id: 'q9',
    category: 'program',
    question: 'I am a complete beginner. Is the placement test right for me?',
    answer:
      'Yes. The test is designed to place you accurately at any level, including A1. If your result is A1, you will be placed in a beginner cohort with others at the same starting point.',
  },
  {
    id: 'q10',
    category: 'technical',
