...
import { Section, ButtonLink, Badge, Reveal } from '@/components/ui';
  ...
  return (
    <Section size="md" variant="default">
      <div className="max-w-3xl mx-auto">
        ...
        <Reveal variant="blur" delay={0.1} duration={0.65}>
          <div className="relative border border-accent/25 rounded-md overflow-hidden bg-paper-raised shadow-card-accent">
            ...
            <div
              ...
              style={{
                ...
                height: '1px',
                background:
                  'linear-gradient(to right, transparent, rgb(var(--color-accent) / 0.50), transparent)',
              }}
            />
            ...
            <div
              ...
              style={{
                ...
                pointerEvents: 'none',
                background:
                  'radial-gradient(ellipse 90% 55% at 8% 5%, rgb(var(--color-accent) / 0.09), transparent 60%), radial-gradient(ellipse 60% 45% at 92% 95%, rgb(var(--color-highlight) / 0.05), transparent 55%)',
              }}
            />

            {/* Decorative corner accent */}
            <div className="absolute top-0 right-0 w-32 h-32 bg-accent-soft -translate-y-1/2 translate-x-1/2 rounded-full opacity-50" />
